    ...
    */
    private function encodeHeader($input, $charset = 'ISO-8859-1')
    {
        ...
        foreach ($matches[1] as $value) {
            ...
            $input = str_replace($value, '=?' . $charset . '?Q?'. $replacement . '=20?=', $input);
       }

       return $input;
    }

	private function old_encodeHeader($str, $charset='ISO-8859-1')
	{
        ...
        switch ($type) {
            case 'mail':
                ...
                if (!empty($this->headers['Subject'])) {
                    ...
                    //$subject = $this->headers['Subject']; //$this->encodeHeader($this->headers['Subject'], $this->build_params['head_charset']);
